  ...
  return (
      <section>
        ...
        <p className="mb-4">
          ...
          the world. From platforms like Khan Academy making education accessible to
        ...
        <p className="mb-4">
          Therefore, I’m passionate about <b>problem-solving</b> and <b>creative engineering</b>, viewing
